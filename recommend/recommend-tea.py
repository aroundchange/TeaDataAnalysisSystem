# -*- coding = utf8 -*-
# @Time  :2022/1/19 23:01
# @Author : Nico
# File : recommend-tea.py
# @Software: PyCharm
...
# path = r'D:\TeaDataAnalysis\tea.db'
# conn = sql.connect(path)
# cursor = conn.cursor()
# from sqlalchemy import create_engine
# engine = create_engine(r'sqlite:///D:\TeaDataAnalysis\tea.db')
# df.to_sql('retea', engine, if_exists='replace', index=False)
